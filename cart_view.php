	        	...
	        	<div class="col-sm-9">
	        		...
	        		<?php
	        			if(isset($_SESSION['user'])){
	        				 $id = 'OR-'.time().uniqid();
	        				echo "
	        						        		<div style='margin-bottom: 10px;'><a href='check_out.php?pay=".$id."' class='btn btn-success' value='' id='checkout-btn'>".$lang['Check Out']."</a></div>
	        				";
	        			}
	        			else{
	        				echo "
	        					<h4 dir=".$lang['dir'].">".$lang['need to login'].".</h4>
	        				";
	        			}
	        		?>
	        	</div>
