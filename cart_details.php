<?php
	...
	if(isset($_SESSION['user'])){
		...
		try{
			$total = 0;
			$stmt = $conn->prepare("SELECT *, cart.id AS cartid FROM cart LEFT JOIN products ON products.id=cart.product_id WHERE cart.user_id=:user");
			...
			$output .= "
				<tr>
					<td colspan='5' align='right'><b>".$lang['dlivery']."</b></td>
					<td style='text-align: center;'><b>".number_format(24, 2)." EGP</b></td>
				<tr>			
				<tr>
					<td colspan='5' align='right'><b>".$lang['total']."</b></td>
					<td style='text-align: center;'><b>".number_format($total+24, 2)." EGP</b></td>
				<tr>
			";
			}
		...
		if(count($_SESSION['cart']) != 0){
			...
			$output .= "
				<tr>
					<td colspan='5' align='right'><b>".$lang['total']."</b></td>
					<td style='text-align: center;'><b>".number_format($total, 2)." EGP</b></td>
				<tr>
			";
		}
			...
			$output .= "
				<tr>
					<td colspan='6' align='center'>".$lang['Shopping cart empty']."</td>
				<tr>
			";
		}
