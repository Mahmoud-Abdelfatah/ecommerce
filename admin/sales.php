                        ...
                        echo "
                          <tr>
                            ...
                            ";
                             ...
                             echo  " 
                                <td>
                                  <select id='".$row['salesid']."'>                                 
                                   <option value='Canceled'>Canceled</option>
                                   <option value='In-Progress'>In-Progress</option>
                                   <option value='Pendding'>Pendding</option>
                                   <option value='Closed'>Closed</option>
                                  </select>
                                  <button type='button' class='btn btn-success btn-sm btn-flat changestatus' data-id='".$row['salesid']."'>Change</button>
                                </td>";                                                                   
                          echo "</tr>";
